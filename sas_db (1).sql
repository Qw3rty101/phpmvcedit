...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Jan 2024 pada 18.02
...
--
DELIMITER $$
CREATE TRIGGER `trg_delPkl_tbl_sas_pkl` BEFORE DELETE ON `tbl_sas_pkl` FOR EACH ROW BEGIN
    -- Logika tambahan jika diperlukan
    DELETE FROM tbl_pkl_daftar WHERE id_info = OLD.id_info AND id_daftar = id_daftar;
END
$$
DELIMITER ;
...
--
ALTER TABLE `tbl_pkl_daftar`
  MODIFY `id_daftar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
