    ...
    <div class="list-group mt-4">
        <?php foreach ($data['pkl'] as $pkl) : ?>
            <?php if ($pkl['jumlahPendaftar'] < $pkl['jml_pendaftar']) : ?>
                <a href="<?= isset($_SESSION['siswa']) ? BASEURL . "/pkl/daftar/" . $pkl['id_info'] : '#' ?>" class="list-group-item list-group-item-action flex-column align-items-start" <?php if (isset($_SESSION['siswa'])) { echo 'onclick="return confirm(\'Apakah Anda yakin ingin mendaftar?\')'; } ?>">
